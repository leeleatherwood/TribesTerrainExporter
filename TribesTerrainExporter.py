#!/usr/bin/env python3
"""
Starsiege: Tribes Terrain Exporter

Export Starsiege: Tribes .ted terrain files to heightmaps, material maps,
and rendered textures for use in modern game engines.
...
Examples:
  ...
  python TribesTerrainExporter.py myterrain.ted --tile-size 128 --debug
    ...
    parser.add_argument('terrain_file', help='Path to .ted terrain file')
    parser.add_argument(
        '-o', '--output', 
        dest='output_dir', 
